 ...
 */
public class DepartmentTwoFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // ListView lv = (ListView)rootView.findViewById(R.id.listview);
        //lv.setEmptyView(rootView.findViewById(R.id.emptyView));
